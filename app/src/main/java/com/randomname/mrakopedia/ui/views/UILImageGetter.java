...
public class UILImageGetter implements Html.ImageGetter {
     ...
     * @param c
     */
    public UILImageGetter(View t, Context c, String urlPrefix) {
        this.c = c;
    ...
    public Drawable getDrawable(String source) {
        ...
        urlDrawable.drawable = c.getResources().getDrawable(R.mipmap.ic_launcher);

        ImageLoader imageLoader = ImageLoader.getInstance();
        imageLoader.init(ImageLoaderConfiguration.createDefault(c));

        imageLoader.loadImage(source, new SimpleListener(urlDrawable));
        return urlDrawable;
    }
    ...
    private class SimpleListener extends SimpleImageLoadingListener {
        ...
        public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
            ...
            urlImageDownloader.setBounds(0, 0, width, height);
